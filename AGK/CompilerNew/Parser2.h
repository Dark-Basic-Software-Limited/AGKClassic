...
namespace AGK_Compiler
{
	class Parser2
	{
		...
		public:
			...
			int ParseArrayExpression( stFunction *pFunction, cProgramData *pProgram, int &dataType, stVariable *pParentVar, DynArrayObject<stInstruction> *pInstructions, int tokenID, int &consumed );
			int ParseTypeExpression( stFunction *pFunction, cProgramData *pProgram, int &dataType, stVariable *pParentVar, DynArrayObject<stInstruction> *pInstructions, int tokenID, int &consumed );
			int ParseExpression( stFunction *pFunction, int allowFunctions, int prevPrec, int &dataType, DynArrayObject<stInstruction> *pInstructions, cProgramData *pProgram, int tokenID, int &consumed );
			...
			int FirstPass( cProgramData *pProgram );
